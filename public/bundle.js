...
/***/ function(module, exports, __webpack_require__) {
	...
	var Article = _react2.default.createClass({
		...
		render: function render() {
			...
			return _react2.default.createElement(
				'li',
				{ className: 'list-item', style: { listStyle: "none", padding: "5px", border: '1px solid #ccc', marginBottom: '2px' } },
				_react2.default.createElement(
					'a',
					{ href: this.props.url, target: '_blank', style: { textDecoration: "none" } },
					_react2.default.createElement(
						'h4',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var GetSearchTerm = __webpack_require__(233);
